...
<div class="tituloPagina">
    USUÁRIOS - <a href="<% out.print(Utils.ABSOLUTESGC+"Usuarios?acao=inserir");%>">Inserir novo Usuário</a>
</div>
...
<form action="<% out.print(Utils.ABSOLUTESGC);%>Usuarios" method="post">
    ...
    <table width="940" border="0" cellspacing="0" cellpadding="0" id="tableList">
        ...
        <tbody>
            ...
            <tr>
                ...
                <!--Editar !-->
                <td class="principal">
                    <a href="<% out.print(Utils.ABSOLUTESGC+"Usuarios?acao=editar&id="+u.getId());%>">Editar</a>
                </td>
