...
<div class="tituloPagina">
    Resultados - <a href="<% out.print(Utils.ABSOLUTESGC);%>Resultados?acao=inserir">Inserir novo Resultado</a>
</div>
...
<table width="940" border="0" cellspacing="0" cellpadding="0" id="tableList">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="<% out.print(Utils.ABSOLUTESGC+"Resultados?acao=editar&id="+u.getId());%>">Editar</a>
            <td>
