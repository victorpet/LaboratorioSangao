...
<div class="tituloPagina">
    PACIENTES - <a href="<% out.print(Utils.ABSOLUTESGC);%>pacientes/pacientes_inserir.jsp">Inserir novo Paciente</a>
</div>
...
<form action="<% out.print(Utils.ABSOLUTESGC);%>Pacientes" method="post">
    ...
    <table width="940" border="0" cellspacing="0" cellpadding="0" id="tableList">
        ...
        <tbody>
            ...
            <tr>
                <!-- Checkbox!-->
                <td align="center">
                    <input type="checkbox" name="ids[]" value="<% out.print(p.getId());%>"/>
                </td>
                ...
                <!--Editar !-->
                <td class="principal">
                    <a href="<% out.print(Utils.ABSOLUTESGC+"Pacientes?acao=editar&id="+p.getId());%>">Editar</a>
                </td>
