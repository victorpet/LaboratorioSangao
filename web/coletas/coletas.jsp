...
<div class="tituloPagina">
    COLETAS - <a href="<% out.print(Utils.ABSOLUTEPATH);%>coletas/coletas_inserir.jsp">Inserir nova coleta</a>
</div>
...
<form action="<% out.print(Utils.ABSOLUTEPATH);%>Coletas" method="post">
    ...
    <table width="940" border="0" cellspacing="0" cellpadding="0" id="tableList">
        ...
        <tbody>
            ...
            <tr>
                ...
                <!--Editar !-->
                <td class="principal">
                    <a href="<% out.print(Utils.ABSOLUTEPATH+"Coletas?acao=editar&id="+c.getId());%>">Editar</a>
                </td>
